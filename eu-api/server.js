...
const KEYCLOAK_EXTERNAL_URL =
  process.env.KEYCLOAK_EXTERNAL_URL || "http://localhost:8081";
const REALM = process.env.KEYCLOAK_REALM || "eu-realm";
...
app.get("/api/data", authenticate, (req, res) => {
  res.json({
    ...
    data: [
      {
        id: 1,
        name: "EU Frankfurt Data Center",
        status: "operational",
        latency: "10ms",
      },
      {
        id: 2,
        name: "EU Dublin Data Center",
        status: "operational",
        latency: "14ms",
      },
      {
        id: 3,
        name: "EU Stockholm Data Center",
        status: "operational",
        latency: "11ms",
      },
    ],
